      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 640px) {
          .search-card-body { grid-template-columns: 1fr; }
        }
        ...
        @media (max-width: 640px) {
          .more-filters-section { grid-template-columns: 1fr; }
        }
      `}</style>
      ...
      <main className="main-content">
        ...
        <div className="search-card">
          <div className="search-card-header">
            ...
            {submitted && (
              <span style={{ fontSize: "12px", color: "#6b7280" }}>All fields optional</span>
            )}
          </div>
          ...
          <div className="search-card-body">
            ...
            <div className="field-group full-width">
              <button className="more-filters-btn" onClick={() => setShowMoreFilters(!showMoreFilters)}>
                ...
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" style={{ transform: showMoreFilters ? "rotate(180deg)" : "none", transition: "transform 0.2s" }}>
          ...
          <div>
            {[1, 2, 3].map((i) => (
              <div key={i} className="skeleton-card">
                ...
                <div className="skeleton-line narrow" style={{ marginBottom: "16px" }} />
        ...
        {submitted && !trialsLoading && trials.length === 0 && (
          <div className="empty-state">
            ...
            <div className="empty-title">No trials found</div>
            <div className="empty-desc">Try broadening your search or using different terms.</div>
          </div>
        )}
          ...
          <>
            <div className="results-header">
              <span className="results-count">
                Found <strong>{trials.length}</strong> trial{trials.length !== 1 ? "s" : ""}
                {condition && <> for <strong>{condition}</strong></>}
              </span>
            </div>
