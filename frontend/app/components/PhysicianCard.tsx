  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.boxShadow = "0 3px 16px rgba(99,102,241,0.09)";
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontSize: "13px", fontWeight: 600, color: "#0f172a", marginBottom: "2px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
          {displayName}
          {doctor.credential && (
            <span style={{ fontWeight: 400, color: "#94a3b8", marginLeft: "4px", fontSize: "11px" }}>{doctor.credential}</span>
          )}
        </div>

        {doctor.taxonomyDescription && (
          <div style={{ fontSize: "11px", color: "#6366f1", fontWeight: 500, marginBottom: "3px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
            {doctor.taxonomyDescription}
          </div>
        )}
        ...
        {doctor.taxonomyCode && (
          <div style={{ marginBottom: "4px" }}>
            <span style={{ fontSize: "10px", fontFamily: "monospace", background: "rgba(99,102,241,0.07)", color: "#6366f1", padding: "2px 6px", borderRadius: "5px", border: "1px solid rgba(99,102,241,0.14)" }}>
              {doctor.taxonomyCode}
            </span>
          </div>
        )}
        ...
        <div style={{ display: "flex", gap: "12px", marginTop: "5px", flexWrap: "wrap" }}>
          {doctor.phone && (
            <div style={{ fontSize: "11px", color: "#94a3b8", cursor: "pointer", transition: "color 0.15s" }}
          ...
          {doctor.email && (
            <div style={{ fontSize: "11px", color: "#94a3b8", cursor: "pointer", transition: "color 0.15s", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}
